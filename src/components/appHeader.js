...
//     }
//     // If already on the Welcome screen, do nothing
//   };

//   // Reset modal state when AppHeader is focused
//   useFocusEffect(
//     React.useCallback(() => {
//       setIsModalVisible(false); // Close the modal when the screen comes into focus
//     }, [])
//   );
...
//         </TouchableOpacity>
//         <TouchableOpacity style={styles.iconButton} onPress={navigateToWelcomeScreen}>
//           <Image
